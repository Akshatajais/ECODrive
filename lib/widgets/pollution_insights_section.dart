...
class PollutionInsightsSection extends StatefulWidget {
  const PollutionInsightsSection({super.key});

  @override
  State<PollutionInsightsSection> createState() => _PollutionInsightsSectionState();
}

class _PollutionInsightsSectionState extends State<PollutionInsightsSection> {
  ...
  final List<String> _goodPractices = const [
